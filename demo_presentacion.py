...
def train_data():
	...
	SGD8 = svm.LinearSVC(C=0.5, random_state = 42).fit(X_train_tfidf, target)
	...
	while True:
		...
		predicted = SGD8.predict(X_new_tfidf)
		...
		if res == 0: 
			tendencia = "Pro-Gobierno"
		else:
			tendencia = "Contra-Gobierno"
		print("La tendencia polícata predicha por el clasificador fue:")
		print tendencia
