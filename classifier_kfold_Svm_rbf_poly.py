...
for train, test in kf.split(user,clas):
    ...
    SGD1 = svm.SVC(C=1.0, kernel='rbf', cache_size = 2000, random_state = 42).fit(X_train_counts1, target)
    print 1
    SGD2 = svm.SVC(C=1.0, kernel='rbf', cache_size = 2000, random_state = 42).fit(X_train_counts2, target)
    print 2
    SGD3 = svm.SVC(C=1.0, kernel='rbf', cache_size = 2000, random_state = 42).fit(X_train_tfidf1, target)
    print 3
    SGD4 = svm.SVC(C=1.0, kernel='rbf', cache_size = 2000, random_state = 42).fit(X_train_tfidf2, target)
    print 4
    SGD5 = svm.SVC(C=1.0, kernel='poly', cache_size = 2000, random_state = 42).fit(X_train_counts1, target)
    print 5
    SGD6 = svm.SVC(C=1.0, kernel='poly', cache_size = 2000, random_state = 42).fit(X_train_counts2, target)
    print 6
    SGD7 = svm.SVC(C=1.0, kernel='poly', cache_size = 2000, random_state = 42).fit(X_train_tfidf1, target)
    print 7
    SGD8 = svm.SVC(C=1.0, kernel='poly', cache_size = 2000, random_state = 42).fit(X_train_tfidf2, target)
    print 8
