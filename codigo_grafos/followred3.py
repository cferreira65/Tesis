...
for user in ids_opos[2800:3100]:
#     #print user
    i = i + 1
    try:
...
nx.write_graphml(g_all,'follow_all_2800-3100.xml')
nx.write_graphml(g_opos,'follow_opos_2800-3100.xml')
nx.write_graphml(g_chav,'follow_chav_2800-3100.xml')
