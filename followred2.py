...
for user in ids_opos[2500:2800]:
#     #print user
    i = i + 1
    try:
...
nx.write_graphml(g_all,'follow_all_2500-2800.xml')
nx.write_graphml(g_opos,'follow_opos_2500-2800.xml')
nx.write_graphml(g_chav,'follow_chav_2500-2800.xml')
