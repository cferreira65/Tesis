...
for train, test in kf.split(user,clas):
    ...
    SGD1 = svm.SVC(C=1.0, random_state = 42, kernel = 'sigmoid').fit(X_train_counts1, target)
    print 1
    SGD2 = svm.SVC(C=1.0, random_state = 42, kernel = 'sigmoid').fit(X_train_counts2, target)
    print 2
    SGD3 = svm.SVC(C=1.0, random_state = 42, kernel = 'sigmoid').fit(X_train_tfidf1, target)
    print 3
    SGD4 = svm.SVC(C=1.0, random_state = 42, kernel = 'sigmoid').fit(X_train_tfidf2, target)
    print 4
    SGD5 = svm.SVC(C=0.5, random_state = 42, kernel = 'sigmoid').fit(X_train_counts1, target)
    print 5
    SGD6 = svm.SVC(C=0.5, random_state = 42, kernel = 'sigmoid').fit(X_train_counts2, target)
    print 6
    SGD7 = svm.SVC(C=0.5, random_state = 42, kernel = 'sigmoid').fit(X_train_tfidf1, target)
    print 7
    SGD8 = svm.SVC(C=0.5, random_state = 42, kernel = 'sigmoid').fit(X_train_tfidf2, target)
    print 8
    ...
    string = "resultados_sigmoid/sin_ninguno/res_kfold" + str(i) + ".txt"
    i = i + 1
    out = open(string, 'w')
...
out = open("resultados_sigmoid/sin_ninguno/avg_kfold.txt", 'w')
