...
<<<<<<< HEAD
for user in ids_opos[1500:2000]:
=======
for user in ids_opos[1000:1500]:
>>>>>>> 860f1dc1e9566d9d763300a70b864f56df8605d3
#     #print user
    i = i + 1
    try:
...
<<<<<<< HEAD
nx.write_graphml(g_all,'follow_all_1500-2000.xml')
nx.write_graphml(g_opos,'follow_opos_1500-2000.xml')
nx.write_graphml(g_chav,'follow_chav_1500-2000.xml')
=======
nx.write_graphml(g_all,'follow_all_1000-1500.xml')
nx.write_graphml(g_opos,'follow_opos_1000-1500.xml')
nx.write_graphml(g_chav,'follow_chav_1000-1500.xml')
>>>>>>> 860f1dc1e9566d9d763300a70b864f56df8605d3
